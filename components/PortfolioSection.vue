...
<template>
    <div id='Portfolio' class="relative flex items-top justify-center bg-slate sm:items-center sm:pt-0 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="mt-1 bg-white overflow-hidden shadow sm:rounded-lg p-6">
